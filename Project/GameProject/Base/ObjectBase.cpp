...
void ObjectBase::Update() {
	...
	m_collisionList = TaskManager::GetCollisionTargets(this);
}
...
CVector3D ObjectBase::GetForward() const{
	CVector3D forwardDirection(-m_rot.x, 0.0f, -m_rot.z);
	return forwardDirection.GetNormalize();
}
